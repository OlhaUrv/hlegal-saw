(() => {
	const burgerOpen = document.querySelector('.header__box-burger, .header-white__box-burger')
	const burgerClose = document.querySelector('.header__nav-close, .header-white__nav-close')
	const navigation = document.querySelector('.header__nav, .header-white__nav')
